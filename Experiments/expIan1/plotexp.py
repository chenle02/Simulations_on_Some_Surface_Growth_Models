...
for file in files:
    ...
    TB.ComputeSlope_fine(low_threshold=0.1, high_threshold=0.2)
    TB.ComputeSlope_fine(low_threshold=0.1, high_threshold=0.3)
    TB.ComputeSlope_fine(low_threshold=0.1, high_threshold=0.4)
    TB.ComputeSlope_fine(low_threshold=0.1, high_threshold=0.5)
    TB.ComputeSlope_fine(low_threshold=0.1, high_threshold=0.6)
    TB.ComputeSlope_fine(low_threshold=0.1, high_threshold=0.7)
    TB.ComputeSlope_fine(low_threshold=0.1, high_threshold=0.8)
    TB.ComputeSlope_fine(low_threshold=0.1, high_threshold=0.9)
    TB.ComputeSlope_fine(low_threshold=0.1, high_threshold=1)
