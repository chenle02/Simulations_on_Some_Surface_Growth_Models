...
for type_value in distinct_types:
    ...
    for width_value in distinct_widths:
        ...
        fluctuations_list = [np.frombuffer(fluctuation[0], dtype=np.float32) for fluctuation in fluctuations]
...
# At this point, fluctuations_dict is structured as follows:
# {
#   'type1': {
#       width1: [array1, array2, ...],
#       width2: [array1, array2, ...],
#       ...
#   },
#   'type2': {
#       ...
